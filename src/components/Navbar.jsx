        ...
        <Navbar>
            <Container>
                <Navbar.Brand> 
                    ...
                    <Nav style={{textAlign:"right", marginLeft:"30px", fontSize:"15px", marginTop:"5px"}}>
                        <Nav.Link style={{marginRight:"30px", color:"white"}} href="/">Beranda</Nav.Link>   
                        ...
                        <Nav.Link style={{marginRight:"30px",color:"white", marginLeft:"10px"}}href="/"><b>logout</b></Nav.Link>   
                    </Nav>
            </Container>
        </Navbar>
    </div>
